      ...
      {products.map((p) => (
        <div key={p.id} className="print-card">
          ...
          {p.qr?.imageUrl ? (
            ...
            <div style={{ width: "180px", height: "180px", border: "1px dashed #cbd5e1", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", color: "#64748b", borderRadius: "8px", marginBottom: "16px" }}>
              Sin QR generado
            </div>
          )}
